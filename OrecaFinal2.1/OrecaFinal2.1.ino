...
void setup()
{
  ...
  Serial.println("L1_stat: " + String(L1_stat) + " || L2_stat: " + String(L2_stat));
...
//        Serial.println(TcpOrder);
      ...
      Serial.println("Before Devices Routine >>>>>>");
      Devices(devicetype, defaultOrder, 0);
    }
  }
...
// *************************************************************************************************************
  ...
  Serial.println("Before Get FireOrder ........");
...
//    if(FireOrder.indexOf("DeviceType")>= 0){
//      FireOrder.remove(0, FireOrder.indexOf(',')+1);
//      if(FireOrder == "S"){
//        devicetype = 'S';
//        FireFlag[1] == 1;
//        FireReport();
//        EEPROM.write(0, devicetype);
//        EEPROM.commit();
//        }
//      else{ // ............................................ Turn Devicetype to Array in EEPROM
//        devicetype= FireOrder;
//        FireFlag[1] == 1;
//        FireReport();
//        EEPROM.write(0, devicetype);
//        EEPROM.commit();
...
//      }
    ...
    //Action Operation
      ...
      Serial.println(Order[0]+Order[1]+Order[2]);
...
void FireReport()
{
  ...
  Serial.println("FireReporter Fn");
  if (FireFlag[0] == 1)
  {
...
void Devices(char devicetype, String XOrder[3], bool FireOrTCP)
{
   ...
   if (XOrder[0] == "D") // ----------- Digital Outputs 
  {
    ...
    EEPROM.commit();
    Serial.println("Load >> " + XOrder[1] + " Value: " + XOrder[2]);
    FireFlag[0] = 1;
    if (FireOrTCP == 1) {
    FireReport();
    }
